 ...
 */
final class Version20190701124410 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, user_name VARCHAR(128) NOT NULL COLLATE utf8mb4_unicode_ci, user_email VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, user_password VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, user_age INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
